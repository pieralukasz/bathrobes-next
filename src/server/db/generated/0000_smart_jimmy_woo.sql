...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "ll-bathrobes_product_colors" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "ll-bathrobes_product_colors_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "ll-bathrobes_product_sizes" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "ll-bathrobes_product_sizes_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "ll-bathrobes_basket_items" ADD CONSTRAINT "ll-bathrobes_basket_items_product_size_id_ll-bathrobes_product_sizes_id_fk" FOREIGN KEY ("product_size_id") REFERENCES "public"."ll-bathrobes_product_sizes"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "ll-bathrobes_order_items" ADD CONSTRAINT "ll-bathrobes_order_items_product_size_id_ll-bathrobes_product_sizes_id_fk" FOREIGN KEY ("product_size_id") REFERENCES "public"."ll-bathrobes_product_sizes"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "ll-bathrobes_product_colors" ADD CONSTRAINT "ll-bathrobes_product_colors_product_id_ll-bathrobes_products_id_fk" FOREIGN KEY ("product_id") REFERENCES "public"."ll-bathrobes_products"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "ll-bathrobes_product_sizes" ADD CONSTRAINT "ll-bathrobes_product_sizes_color_id_ll-bathrobes_product_colors_id_fk" FOREIGN KEY ("color_id") REFERENCES "public"."ll-bathrobes_product_colors"("id") ON DELETE no action ON UPDATE no action;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
--> statement-breakpoint
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "ean_idx" ON "ll-bathrobes_product_sizes" USING btree ("ean");